...
/*   Updated: 2023/01/04 19:29:22 by zouaraqa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	creat_anim_path(t_var *va)
{
	...
	va->anim.anim_5 = mlx_xpm_file_to_image(va->mlx_ptr, \
		"./textures/5.xpm", &va->width, &va->hight);
	va->anim.anim_6 = mlx_xpm_file_to_image(va->mlx_ptr, \
		"./textures/6.xpm", &va->width, &va->hight);
}
